...
-- ----------------------------------------
INSERT INTO `t_menu` (`id`, `parent_id`, `name`, `path`, `redirect`, `component`, `title`, `icon`, `is_hide`, `is_hide_tab`, `show_badge`, `show_text_badge`, `keep_alive`, `fixed_tab`, `active_path`, `link`, `is_iframe`, `is_full_page`, `is_first_level`, `parent_path`, `order_num`, `status`, `remark`, `is_deleted`, `create_time`, `update_time`)
VALUES (92, 0, 'Exchange', '/exchange', NULL, '/index/index', 'menus.exchange.title', 'ri:chat-smile-3-line', 0, 0, 0, NULL, 0, 0, NULL, NULL, 0, 0, 0, NULL, 7, 1, '交流管理', 0, NOW(), NOW());
INSERT INTO `t_menu` (`id`, `parent_id`, `name`, `path`, `redirect`, `component`, `title`, `icon`, `is_hide`, `is_hide_tab`, `show_badge`, `show_text_badge`, `keep_alive`, `fixed_tab`, `active_path`, `link`, `is_iframe`, `is_full_page`, `is_first_level`, `parent_path`, `order_num`, `status`, `remark`, `is_deleted`, `create_time`, `update_time`)
VALUES (93, 92, 'ExchangeArticleManage', 'article-list', NULL, '/exchange/article-list', 'menus.exchange.articleManage', 'ri:article-line', 0, 0, 0, NULL, 1, 0, NULL, NULL, 0, 0, 0, NULL, 1, 1, '交流文章管理', 0, NOW(), NOW());
INSERT INTO `t_menu` (`id`, `parent_id`, `name`, `path`, `redirect`, `component`, `title`, `icon`, `is_hide`, `is_hide_tab`, `show_badge`, `show_text_badge`, `keep_alive`, `fixed_tab`, `active_path`, `link`, `is_iframe`, `is_full_page`, `is_first_level`, `parent_path`, `order_num`, `status`, `remark`, `is_deleted`, `create_time`, `update_time`)
VALUES (94, 92, 'ExchangeReportManage', 'report', NULL, '/exchange/report', 'menus.exchange.reportManage', 'ri:spam-2-line', 0, 0, 0, NULL, 1, 0, NULL, NULL, 0, 0, 0, NULL, 2, 1, '交流举报管理', 0, NOW(), NOW());
...
CREATE TABLE `t_venue` (
                           ...
                           `image_urls` text COMMENT '场馆图片列表（分号分隔）',
